...
if(this.state.picture_urls.length != 0){
  for(let i = 0; i < this.state.picture_urls.length; i++){
   var slider = <div className='slider-container'><Slider className='slider' {...settings}>
     <div className='img-container'><img className='slider-img' src={this.state.picture_urls[i][0]} /></div>
     <div className='img-container'><img className='slider-img' src={this.state.picture_urls[i][1]} /></div>
     <div className='img-container'><img className='slider-img' src={this.state.picture_urls[i][2]} /></div>
     <div className='img-container'><img className='slider-img' src={this.state.picture_urls[i][3]} /></div>
     <div className='img-container'><img className='slider-img' src={this.state.picture_urls[i][4]} /></div>
   </Slider>
