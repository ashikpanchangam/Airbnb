  ...
  render() {
    return(
      <div {...this.props} className='prev-arrow-header'>
        <i style={{color: 'white', fontSize: '40px'}} className="fa fa-chevron-left" aria-hidden="true"/>
      </div>
    )
  }
}
  ...
  render() {
    ...
    return(
      <div {...this.props} className='next-arrow-header'>
        <i style={{color: 'white', fontSize: '40px'}} className="fa fa-chevron-right" aria-hidden="true"/>
      </div>
      )
  }
}
            ...
            >
              {/*<Slider {...settings}>*/}
                {/*{this.state.listing.picture_urls.map((currentVal, i)=>{*/}
                  {/*return (*/}
                    {/*<div className="room-slider" key={i}><img className="img-slide" src={currentVal}/></div>*/}
                  {/*)*/}
                {/*})}*/}
              {/*</Slider>*/}
            </Dialog>
